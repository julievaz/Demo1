...
class OpportunityController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Opportunity']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->oppID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Opportunity');
	 ...
	 * @param Opportunity $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='opportunity-form')
		{
